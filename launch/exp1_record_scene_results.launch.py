...
def generate_launch_description():
    ...
    joint_bayes_rec_node = Node(package = "mm_scene_rec", 
                    executable = "multimodal_joint_scene_est.py",
                    name = "bayes_joint_scene_est",
                    output = 'screen',
                    parameters=[params]
    )
    ld.add_action(joint_bayes_rec_node)
    ...
    scene_rec_node = Node(package = "c2hi", 
