...
class RecSceneResultsNode(Node):
    ...
    def __init__(self):
        ...
        self.joint_scene_sub = self.create_subscription(CategoricalDistribution, 'bayes_joint_scene_est/joint_scene_category', lambda msg: self.scene_callback(msg, 'joint'), 10)
        ...
        self.scene_est_count_dict = {'audio': 0, 'clip': 0, 'joint': 0}
    ...
    def stop_recording(self, _, resp):
        ...
        self.results_df.to_csv("src/c2hi/results/exp1a_scene_recognition/scene_results_%s.csv" % self.scene_config_name, columns = self.results_columns)
